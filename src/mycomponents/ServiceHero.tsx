...
export default function ServiceHero(){
    return (
        ...
        <h1 className="font-bold text-center flex justify-center items-center md:text-2xl text-xl py-2 text-white">Home <ChevronRight size={30} className="text-brand translate-y-1" /><a href="/services" className="text-brand">Services</a></h1>
